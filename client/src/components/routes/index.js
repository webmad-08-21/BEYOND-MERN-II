...
const Routes = ({ storeUser, loggedUser }) => {
  return (
    <Switch>
      ...
      <Route exact path="/montañas-rusas" render={() => <CoastersPage loggedUser={loggedUser} />} />
      ...
      <Route path="/montañas-rusas/:id" render={(props) => <CoasterDetails loggedUser={loggedUser} {...props} />} />
